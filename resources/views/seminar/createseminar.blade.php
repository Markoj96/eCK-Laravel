    ...
    <div class="main-wraper-bg mar_lft_282">
        <div class="homepage-sec1">
            <div class="container-fluid">
				...
				<div class="row">
					{!! Form:: open(['action' => 'SeminariController@store', 'method' => 'POST']) !!}
						<div class="form-group">
							{{Form::label('tema', 'Tema')}}
							{{Form::text('tema', '', ['class' => 'form-control', 'placeholder' => 'Tema seminara'])}}
						</div>
						<div class="form-group">	
							{{Form::label('brojUcesnika', 'Broj ucesnika')}}
							{{Form::text('brojUcesnika', '', ['class' => 'form-control', 'placeholder' => 'Broj ucesnika na seminaru'])}}
                        </div>
                        <div class="form-group">	
                            {{Form::label('mesto', 'Mesto')}}
                            {{Form::text('mesto', '', ['class' => 'form-control', 'placeholder' => 'Mesto seminara'])}}
                        </div>
                        <div class="form-group">	
							{{Form::label('datum', 'Datum odrzavanja')}}
							{{Form::date('datumOdrzavanja', '', ['class' => 'form-control', 'placeholder' => 'Datum'])}}
						</div>
                        <div class="form-group">	
                            {{Form::label('opis', 'Opis')}}
                            {{Form::textarea('opis', '', ['class' => 'form-control', 'placeholder' => 'Opis seminara'])}}
                        </div>	
