							...
							<thead>
								...
								@if(count($seminari) > 0)
                                    @foreach($seminari as $seminar)
										...
										<tr>
											<td>
                                                <a href="/modelprojekat/public/seminar/{{$seminar->id}}">{{$seminar->tema}}</a>
											</td>
											<td>
                                            ...
                                            <td>
												{{$seminar->brojUcesnika}}
											</td>
											<td>
                                                <a href="{{ url('createVolSeminar/'.$parametar) }}" class="btn btn-primary">Prijavi se</a>
                                            </td>
										</tr>
									@endforeach
								@else
