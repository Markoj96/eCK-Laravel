					...
					<div class="col col-lg-12">
						<table class="table table-striped">
							<thead>
                                ...
                                @if(count($obucenosti) > 0)
                                    @php $parametar1 = $korisnikID; @endphp
                                    @foreach($obucenosti as $obucenost)

                                        @php $parametar2 = $obucenost->id; @endphp
										<tr>
											<td>
												{{$obucenost->naziv}}
											</td>
											<td>
                                                <a href="{{ url('/obucenost/potvrdi/'.$parametar1.'/'.$parametar2) }}" class="btn btn-primary">Zabelezi</a>
                                            </td>
										</tr>
									@endforeach
								@else
