    ...
    <div class="main-wraper-bg mar_lft_282">
        <div class="homepage-sec1">
            <div class="container-fluid">
				...
				<div class="row">
					{!! Form:: open(['action' => 'AktivnostiController@kreirajAktivnost', 'method' => 'POST']) !!}
						...
						<div class="form-group">	
							{{Form::label('tip', 'Tip')}}
							{{Form::text('tip', '', ['class' => 'form-control', 'placeholder' => 'Tip aktivnosti'])}}
                        </div>
                        <div class="form-group">	
                            {{Form::label('mesto', 'Mesto')}}
                            {{Form::text('mesto', '', ['class' => 'form-control', 'placeholder' => 'Mesto aktivnosti'])}}
                        </div>
                        <div class="form-group">	
                                {{Form::label('opis', 'Opis')}}
                                {{Form::textarea('opis', '', ['class' => 'form-control', 'placeholder' => 'Opis aktivnosti'])}}
                            </div>
						<div class="form-group">	
							{{Form::label('datumOd', 'Datum pocetka')}}
							{{Form::date('datumOd', '', ['class' => 'form-control', 'placeholder' => 'Datum pocetka aktivnost'])}}
						</div>
