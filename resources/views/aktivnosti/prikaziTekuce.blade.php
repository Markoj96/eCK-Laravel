							...
							<thead>
								...
								@if(count($aktivnosti) > 0)
                                    @foreach($aktivnosti as $aktivnost)
                                        @php $parametar = $aktivnost->id; @endphp
										<tr>
											<td>
											...
											<td>
                                                <a href="{{ url('/ucesce/create/'.$parametar) }}" class="btn btn-primary">Prijavi se</a>
                                            </td>
					                        @if((auth()->user()->pravaPristupa!='V'))
                                            <td>
                                                <a href="{{ url('/volonteriOdredjeneAktivnosti/' . $parametar . '/edit') }}" class="btn btn-danger">Kraj aktivnosti</a>
                                            </td>
                                            @endif
										</tr>
									@endforeach
