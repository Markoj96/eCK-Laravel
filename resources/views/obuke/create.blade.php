    ...
    <div class="main-wraper-bg mar_lft_282">
        <div class="homepage-sec1">
            <div class="container-fluid">
				...
				<div class="row">
					{!! Form:: open(['action' => 'ObukeController@store', 'method' => 'POST']) !!}
						<div class="form-group">
							{{Form::label('obucenost', 'Obucenost')}}
							{{Form::select('obucenost', $obucenosti, ['class' => 'form-control', 'placeholder' => 'Obucenost'])}}
                        </div>
                        <div class="form-group">	
							{{Form::label('datumOdrzavanja', 'Datum Odrzavanja')}}
							{{Form::date('datumOdrzavanja', '', ['class' => 'form-control', 'placeholder' => 'Datum pocetka obuke'])}}
						</div>
						<div class="form-group">	
							{{Form::label('mesto', 'Mesto')}}
							{{Form::text('mesto', '', ['class' => 'form-control', 'placeholder' => 'Mesto odrzavanja'])}}
                        </div>
                        <div class="form-group">	
                            {{Form::label('brojUcesnika', 'Broj ucesnika')}}
                            {{Form::text('brojUcesnika', '', ['class' => 'form-control', 'placeholder' => 'Broj ucesnika'])}}
                        </div>
                        <div class="form-group">	
                                {{Form::label('opis', 'Opis')}}
                                {{Form::textarea('opis', '', ['class' => 'form-control', 'placeholder' => 'Opis obuke'])}}
                        </div>
