        ...
        <div class="homepage-sec1">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">					
                        <div class="card">
                            <div class="card-header">{{ $volonter->ime }} {{ $volonter->prezime }}</div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('volonterSacuvaj') }}" enctype="multipart/form-data">
                                    @csrf
									@php
										$user = $volonter;
										$ime = $user->ime;
                                    ...
                                    <div class="form-group row">
                                        <label for="pravaPristupa" class="col-sm-4 col-form-label text-md-right">{{ __('Pravo pristupa') }}</label>
            
                                        <div class="col-md-6">
                                            @switch($pravaPristupa)
                                                @case("V")
                                                    <select id="pravaPristupa" name="pravaPristupa">
                                                        <option value="V" selected>Volonter</option>
                                                ...
                                                @case("M")
                                                    <select id="pravaPristupa" name="pravaPristupa">
                                                        ...
                                                        <option value="V">Volonter</option>
                                                        <option value="A">Administator</option>
                                                    </select>
                                                @break
                                                @case("A")
                                                    <select id="pravaPristupa" name="pravaPristupa">
                                                        <option value="A" selected>Administator</option>
                                                        <option value="V">Volonter</option>
                                                        <option value="M">Moderator</option>
                                                    </select>
                                                @break
